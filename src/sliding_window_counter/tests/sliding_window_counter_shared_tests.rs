...
mod sequential_tests {
    use crate::sliding_window_counter::{SlidingWindowCounterConfig, SlidingWindowCounterShared};
    ...
    fn basic_test() {
        ...
        let bucket = SlidingWindowCounterShared::new(SlidingWindowCounterConfig {
            capacity: 10,
            window_secs: 2,
        });
